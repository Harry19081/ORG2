...
// every layered rule. These checks keep the Input wrapper's box defaults below
// utilities so `<Input className="w-48" />` applies, while the modifiers that
// must beat Input's own `rounded-lg bg-bg-2` utilities stay unlayered.
