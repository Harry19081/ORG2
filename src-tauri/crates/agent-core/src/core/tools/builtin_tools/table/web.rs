...
pub(super) static TOOLS: &[ToolEntry] = &[
    ToolEntry {
        ...
        actions: &[
            action_sub!("list", "List available frontend GUI actions and visible controls", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("inspect", "Inspect frontend GUI action metadata and parameter schemas", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("dispatch", "Dispatch a frontend GUI action", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
        ],
    ...
    ToolEntry {
        ...
        label_failed: "tools.orgiiGuiFailed",
        actions: &[
            action_sub!("open", "Open Spotlight", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("close", "Close Spotlight", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("toggle", "Toggle Spotlight", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("workspace_picker", "Open Spotlight workspace picker", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("branch_picker", "Open Spotlight branch picker", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("file_search", "Open Spotlight file search", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("command_palette", "Open Spotlight command palette", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
            action_sub!("agent_session_search", "Open Spotlight Agent session search", OtherTool, labels: "tools.orgiiGuiRunning", "tools.orgiiGuiDone", "tools.orgiiGuiFailed"),
        ],
        required_capability: CapManagement,
        ..DEFAULT_TOOL_ENTRY
    },
