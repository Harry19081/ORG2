...
| `CollapsibleSection.tsx`                                                                                                                 | 3 (`components/layout/blocks`, `WorkStation/shared/PrimarySidebarLayout`, `Browser/…/DesignPanel`) | Three independent implementations of the same concept; pick the `components/` one                                                                                                                                                                                                                                                                                                                                                         |
