...
| `src/features/Org2Cloud/SignInFeatures.tsx:49` | Autoplay presentation    | keep with reason | User explicitly requested no carousel controls and autoplay by default. Automatic content is not live-announced, and hidden/reduced-motion states suppress rotation                       | None.            |
