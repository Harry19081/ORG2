...
| 2. Dead code / structural duplication | GitHub list-cache ownership                                 | pass    | The cache moved from a Workstation hook directory to `services/git`; Workstation and Kanban now import the same live implementation.                                                               |
