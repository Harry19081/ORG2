...
| 5. Default branch analysis                | pass          | New users retain the left-side default. Migration precedence is explicit: canonical value, valid legacy Workstation value, valid legacy Agent Station value, then the schema default.                                                                               |
| 6. Cross-domain leakage                   | pass          | Shared layout consumers import a station-neutral atom; no Workstation or Agent Station position concept leaks into shared state.                                                                                                                                    |
...
| Entry point             | Canonical write/read                             | Workstation consumer                          | Agent Station consumer                         |
| ----------------------- | ------------------------------------------------ | -------------------------------------------- | ---------------------------------------------- |
